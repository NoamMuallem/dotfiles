...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp_luasnip", "nvim-autopairs", "LuaSnip", "cmp-buffer", "friendly-snippets", "cmp-nvim-lsp" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'dressing.nvim', 'persistence.nvim', 'gitsigns.nvim', 'indent-blankline.nvim', 'nvim-lspconfig', 'trouble.nvim', 'nvim-colorizer.lua'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
