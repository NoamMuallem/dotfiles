...
local leader = {
  ...
  f = {
    name = "+file",
    t = { "<cmd>lua require 'telescope'.extensions.file_browser.file_browser()<CR>", "NvimTree" },
...
util.nnoremap("<Leader>P",'"0P')
util.nnoremap("<Leader>p",'"0p')

--overriding original customization for pasting
util.nnoremap("P",'P')
util.nnoremap("p",'p')
...
util.vnoremap("<Leader>'", " <esc>`>a'<esc>`<i'<esc>")
util.vnoremap('<Leader>"', '<esc>`>a"<esc>`<i"<esc>')
util.vnoremap("<Leader>`", "<esc>`>a`<esc>`<i`<esc>")
util.vnoremap("<Leader>(", "<esc>`>a)<esc>`<i(<esc>")
util.vnoremap("<Leader>{", "<esc>`>a}<esc>`<i{<esc>")
...
util.nnoremap("<leader>k",  ":<c-u>put!=repeat([''],v:count)<bar>']+1<cr>")
util.nnoremap("<leader>j",  ":<c-u>put =repeat([''],v:count)<bar>'[-1<cr>")

--move lines and selected lines
util.nnoremap('-', '"ldd$"lp')
util.nnoremap('_', '"ldd2k"lp')
util.vnoremap('_', ":'<,'> m '<-2<CR>gv")
util.vnoremap('-', ":'<,'> m '>+1<CR>gv")
...
util.nnoremap ("<Leader>n" ,":tabnew<CR>")
util.nnoremap ("<Leader>N" ,":tabclose<CR>")
